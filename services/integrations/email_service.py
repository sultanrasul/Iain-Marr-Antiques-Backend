...
class EmailService:
    def __init__(self):
        ...
        self.client = Client(auth=(settings.MAILJET_API_KEY, settings.MAILJET_SECRET_KEY), version='v3.1')
        self.today = datetime.now()
    
    def send_email(self, request: PrintRequest):
            ...
            'Messages': [
                {
                    ...
                    "HTMLPart": self.construct_email(products, request.customer_name)
    ...
    def construct_email(self, selected_products: List[Product], customer: str):
